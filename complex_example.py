...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.image_frame.bind("<Configure>", lambda event: self.update_image(event, image_path, self.image_frame))
        ...
        self.update_image(None, image_path, self.image_frame)  # Call update_image to initially display the image
